(function(){
    ...
    var circleText = function (ctx, text, x, y, radius, start, end, forward, around) {
    ...
    // define fill text
    var fillCircleText = function(text, x, y, radius, start, end, forward, around){
        renderType = FILL;
        circleText(this, text, x, y, radius, start, end, forward, around);
    }
    // define stroke text
